...
labelframe= LabelFrame(root, text= "Hello World", font= ('Century 20 bold'),labelanchor= "n",bd=5,bg= "Purple",width= 1340, height= 400) #Creating a frame for the main window
...
def open_second_window(): # Defining a function to open the second window
    ...
    label = tk.Label(second_window, text="This is the second window!")  # Creating a label and adding it to the second window
    label.pack()

    image = tk.PhotoImage(file="image.png")  # Creating an image and adding it to the second window
